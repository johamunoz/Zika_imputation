...
meth[c("inf_weight","inf_head_circ_birth","inf_length","zikv_ga")]<-"norm" # Due to convergence problems imputation based on marginal distribution
...
pred <- quickpred(fdata) # assignation based on pairwise correlation
