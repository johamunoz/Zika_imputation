...
ziktest_ml <- function(data){
  ...
  # Last condition is not specified in the paper and is related to dengue test results interaction. Not sure if it is zero or 1 here, the new variable has a lot of values.. please just modify the number here and below
