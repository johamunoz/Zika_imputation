...
data[,repabort:=ifelse(is.na(loss_etiology),NA,ifelse(loss_etiology==2,1,0))] 
...
table(cvital=data$ch_vital_status,birth=data$birth,useNA = "always") # all are loss from 006 keep as loss
