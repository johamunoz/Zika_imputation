...
studynames<-c("002-BRA","003-GUF","004-ESP","005-ESP","006-COL","007-COL",
              "008-USA","009-GRD","010-BRA","011-BRA","012-TTO","013-BRA","014-BRA",
              "015-BRA","016-HND","017-USA","018-COL","020-BRA","021-PRI",
...
data$ch_czs<-as.factor(data$ch_czs)
data$who_czs<-as.factor(data$who_czs)
data$microcephaly_bin_fet<-as.factor(data$microcephaly_bin_fet)
