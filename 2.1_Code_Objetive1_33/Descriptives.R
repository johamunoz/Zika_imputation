...
table1(~ zikv_preg + zikv_test_ev + zikv_ga | .imp2,data=data ,excel=1)
table1(~ miscarriage + loss + microcephaly + ch_czs + who_czs + efdeath + lfdeath + microcephaly_bin_postnatal + 
         end_ga + ch_weight + neuroabnormality + nonneurologic + microcephaly_bin_fet | .imp2,data=data ,excel=1)
