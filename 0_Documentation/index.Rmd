...
In order to calculate the microscephaly z score we used the who_hcirm2zcore that provide the scores according to WHO definitions. It is necessary to remark that the zscore of follow up measurements taken after 61 months were set to NA as time values are outside the range of the WHO standards.
